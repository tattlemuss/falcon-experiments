...
BLT_HALFTONE_0		equ		$ffff8a00

BLT_SRC_INC_X		equ		$ffff8a20
BLT_SRC_INC_Y		equ		$ffff8a22
BLT_SRC_ADDR_L		equ		$ffff8a24
 
BLT_ENDMASK_1		equ		$ffff8a28
BLT_ENDMASK_2		equ		$ffff8a2a
BLT_ENDMASK_3		equ		$ffff8a2c

BLT_DST_INC_X		equ		$ffff8a2e
BLT_DST_INC_Y		equ		$ffff8a30
BLT_DST_ADDR_L		equ		$ffff8a32

BLT_COUNT_X			equ		$ffff8a36
BLT_COUNT_Y			equ		$ffff8a38

BLT_HOP				equ		$ffff8a3a	; halftone op (BYTE)
...
BLT_OP				equ		$ffff8a3b	; comb operator (BYTE)
...
BLT_MISC_1			equ		$ffff8a3c		; Misc. Register (8 Bits)
...
BLT_MISC_2			equ		$ffff8a3d		; Misc. Register (8 Bits)
